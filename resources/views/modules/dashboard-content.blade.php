...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-md-6 col-xl-4"><x-stat-card title="Progress Pengadaan" value="54%" icon="bi-cart-check" tone="info" subtitle="16 item proses" /></div>
