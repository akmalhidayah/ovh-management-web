...
<div class="content-card">
    <div class="table-responsive">
        <table class="table align-middle ovh-table">
            ...
            <tbody>
    @foreach ([['Checklist Commissioning TG','Checklist','2026','Plant A','Admin OVH','2026-05-03'], ['Report NDT Boiler','Report','2026','Plant B','Inspector OVH','2026-05-06'], ['Drawing Control Panel','Drawing','2026','Plant C','Admin OVH','2026-05-10']] as $i => $row)
