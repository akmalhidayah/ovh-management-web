...
@section('content')
    ...
    <section class="inspector-panel commissioning-list-panel">
                    ...
                    @forelse ($submissions as $submission)
                        <tr>
                            <td>
                                ...
                                <span class="commissioning-status-pill is-draft">{{ $statusLabels[$submission->status] ?? Str::headline($submission->status) }}</span>
                            </td>
                            <td>
        ...
        @include('user.shared.submission-mobile-list', [
            ...
            'emptyMessage' => 'Belum ada draft commissioning.',
        ])
